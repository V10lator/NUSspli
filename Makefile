...
LIBS		:=	-lcurl -lmbedtls -lmbedx509 -lmbedcrypto `$(PREFIX)pkg-config --libs SDL2_mixer SDL2_ttf SDL2_image jansson` -lharfbuzz -lfreetype -lwut -lmocha -lrpxloader $(ROMFS_LIBS)
