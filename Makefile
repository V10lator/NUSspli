...
LIBS		:=	-lcurl -lzstd -lnghttp2 -lbrotlidec -lbrotlicommon -lmbedtls -lmbedx509 -lmbedcrypto `$(PREFIX)pkg-config --libs SDL2_mixer SDL2_ttf SDL2_image harfbuzz jansson` -lwut -lmocha -lrpxloader
